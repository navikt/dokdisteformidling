...
public class EformidlingMottakerInfoService {
	...
	public MottakerInfo hentMottakerInfoTrygderetten() {
		...
		final Optional<ServiceRecord> anyServiceRecord = identifierResource.findServiceRecord(ARKIVMELDING_PROCESS, DPO);
		final ServiceRecord serviceRecord = anyServiceRecord
				.orElseThrow(() -> new MottakerInfoIkkeFunnetException("Fant ikke mottakerinfo for organisasjon=" + TRYGDERETTEN_ORGNUMMER + " og prosess=" + ARKIVMELDING_PROCESS));
