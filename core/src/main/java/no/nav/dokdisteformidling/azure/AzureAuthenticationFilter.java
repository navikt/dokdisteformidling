...
public class AzureAuthenticationFilter implements ExchangeFilterFunction {
	...
	private final AzureEndpointsProperties.AzureEndpoint endpoint;

	public AzureAuthenticationFilter(AzureToken azureToken, AzureEndpointsProperties.AzureEndpoint endpoint) {
