package no.nav.dokdisteformidling.nais;
...
import no.nav.dokdisteformidling.nais.selftest.DependencyCheckResult;
import no.nav.dokdisteformidling.nais.selftest.Importance;
import no.nav.dokdisteformidling.nais.selftest.Result;
import no.nav.dokdisteformidling.nais.selftest.SelftestResult;
...
public class NaisContract {
	...
	@Inject
	public NaisContract(List<AbstractDependencyCheck> dependencyCheckList, MeterRegistry registry, @Value("${APP_NAME:dokdisteformidling}") String appName, @Value("${APP_VERSION:0}") String version) {
