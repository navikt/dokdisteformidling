...
import no.nav.dokdisteformidling.consumer.regoppslag.to.HentMottakerOgAdresseResponseTo;
import no.nav.dokdisteformidling.consumer.sts.STSTokenRetriever;
import no.nav.dokdisteformidling.exception.functional.RegoppslagHentAdresseFunctionalException;
import no.nav.dokdisteformidling.exception.technical.AbstractDokdisteformidlingTechnicalException;
import no.nav.dokdisteformidling.exception.technical.RegoppslagHentAdresseSecurityException;
import no.nav.dokdisteformidling.exception.technical.RegoppslagHentAdresseTechnicalException;
import no.nav.dokdisteformidling.exception.technical.StsRetriveTokenException;
